...
import resumeFile from "./assets/Parthasarathi_M_Resume.pdf";
    ...
    <div className="profile-container">
      ...
      <div className="profile-footer">
        <p style={{ textAlign: "center", fontSize: "1.1em" }}>
          I’d be happy to connect and discuss any professional opportunities.
          You can reach me on
        </p>
        <a
          ...
          style={{
            ...
            transition:
              "color 0.3s ease, transform 0.3s ease, box-shadow 0.3s ease, background-color 0.3s ease", // Added background-color transition
          }}
          onMouseEnter={(e) => {
